...
import ajax.mvc.handler.DogHandler;
import ajax.mvc.utils.JdbcUtils;
...
public class BaseDao {
    ...
    public <T> List<T> selectListCur(Class<T> clazz, String sql , Object... args){
        try {
            con = JdbcUtils.getCon();
            //自定义结果集处理器
            DogHandler<T> dogHandler = new DogHandler();
            return (List<T>) runner.query(con,sql,dogHandler,args);
